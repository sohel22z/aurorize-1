...
<div class="row page-title align-items-center">
    ...
    {{-- <div class="col-sm-auto ml-auto">
        <a href="{{ route('admin.add.email') }}"><button type="button" class="btn bg-primary text-white"> Add New Email Template</button></a>
    </div> --}}
</div>
@endsection
...
<script type="text/javascript">
    var filter_email_url = "{{ route('admin.email') }}";
    var delete_email_url = "{{ route('admin.delete.email') }}";
</script>
