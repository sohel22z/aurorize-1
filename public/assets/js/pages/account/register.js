...
$(function() {
    $(".register-form-validate").validate({
        rules:{
            ...
            email:{required:true,normalizer:function(value){return $.trim(value)},email:false,remote: {type: "POST",url: exists_url,data: {id: $( 'input[name="id"]' ).val()}},maxlength:255,checkEmail:true},
